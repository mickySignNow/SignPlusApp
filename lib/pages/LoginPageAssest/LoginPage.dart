                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //       )
                      InkWell(
                        // if connecting is true then button tap has no action
                        onTap: connecting
                            ? () {}
                            // if phone coonection is true
                            : phoneConnection
                                // if gotSms is true than the user enters the code he gets and logs in by that
                                ? gotSms
                                    ? () async {
                                        try {
                                          var userCredentials =
